...
inLower BT {..} vertices =
  let Triplet l1 l2 l3 = _btLower
  in or [IS.member l1 vertices, IS.member l2 vertices, IS.member l3 vertices]
...
inUpper BT {..} vertices =
  ...
  in R.any (IS.null . IS.intersection vertices) $ [si, sj, sk]
{-# INLINE isInLower #-}
...
filterBTByEdge :: MonadIO m => BT -> HashSet Edge -> ((Int, Int, Int, Int, Int, Int, Int) -> IO ()) -> m ()
...
isInSetEdge :: HashSet Edge -> (Int, Int, Int, Int, Int, Int, Int) -> Bool
isInSetEdge edges (l1, u1, l2, u3, l3, u2, _) =
  R.any (`HS.member` edges) [(u1, l1), (u2, l1), (u1, l2), (u3, l2), (u2, l3), (u3, l3)]
...
byEdge = ByEdge . HS.fromList <$> (string "by-edge" *> (whiteSpace *> many parseEdgeWithComma))
